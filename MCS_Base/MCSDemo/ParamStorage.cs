    ...
    public static class ParamStorage
    {
        ...
        public static void AddCamera()
        {
            ...
            if (rulerCount < 5)
            {
                ...
                string newRulerIp = string.Format("192.168.0.1{0}", (rulerCount + 1).ToString("D2"));
                camera[newCamKey] = newRulerIp;
                ...
                string newCamName = "Ruler" + (rulerCount + 1).ToString();
                MainWindow.Singleton.Camera.AddNewRulerCamera(newCamName, newRulerIp);
            }
        }
        ...
        public static void RemoveCamera()
        {
            ...
            if (rulerCount != 1)
            {
                ...
                MainWindow.Singleton.Camera.RemoveLastRulerCamera();
            }
        }
